...
\begin{abstract}
  This paper investigates an interior-point method for solving large-scale constrained nonlinear programs using graphics processing units (GPUs).
  The interior-point method involves resolving symmetric indefinite linear systems, or Karush-Kuhn-Tucker (KKT) systems,
  which become increasingly ill-conditioned as we approach to the solution.
  Solving the KKT systems using traditional sparse factorization methods involve numerical pivoting that makes parallelization difficult.
