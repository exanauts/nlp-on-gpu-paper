...
\add{This is in line with the recommendation in \cite{golub2003solving},
...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
Most of the error arises in the descent w.r.t. the active bound's multipliers $\widehat{d}_{z,\cactive}$.
