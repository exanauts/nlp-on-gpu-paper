...
the element in the diagonal tends to infinity if a variable converges to its bound,
...
In the worst cases $K_1$ itself may become fully dense if an inequality row is completely dense.
