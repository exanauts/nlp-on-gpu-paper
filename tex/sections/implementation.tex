...
ExaModels.jl compiles the derivative evaluation kernels specifically for the given problem, whereas JuMP and AMPL depend on a precompiled interpreter to evaluate the model's derivatives.
...
\begin{itemize}
  ...
  \item {\tt cuDSS}: Implements \llt, \ldlt and \lu decompositions on an NVIDIA GPU.
    ...
    (here, we have observed that \ldlt is more robust than the Cholesky factorization).
